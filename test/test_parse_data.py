...
def test_interest_distribution_proportional(tmp_path):
    ...
    db_file = tmp_path / "test_interest_proportional.db"
    db = DatabaseHandler(db_file)
    
    # Add data from CSV
    data_adder = DataParser(db)
    data_adder.add_data("./test/data/interest_proportional.csv")
...
def test_interest_distribution_rounding(tmp_path):
    ...
    # Add data from CSV
    data_adder = DataParser(db)
    data_adder.add_data("./test/data/interest_rounding.csv")
